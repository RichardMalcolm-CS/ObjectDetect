...
int main(int, char**) {
    ...
    try {
        string file_path = "C:/Users/N19371/source/repos/proj20/";
        ...
        auto net = readNet("C:/Users/N19371/Downloads/ssd_mobilenet_v2_coco_2018_03_29.tar/ssd_mobilenet_v2_coco_2018_03_29/frozen_inference_graph.pb",
        ...
        for (int i = 0; i < 1; i++) {             //cap.isOpened()) {

            // Load in an image
            Mat image = imread("C:/Users/N19371/Downloads/car.jpg");
            //imshow("imagePreBox", image);
